...
keywords: Azure, java, SDK, API, azure-resourcemanager-azurearcdata, azure-resource-manager
ms.date: 01/29/2026
ms.topic: reference
ms.devlang: java
ms.service: azure-resource-manager
---
# Azure Resource Manager AzureArcData client library for Java - version 1.1.0-alpha.20260129.1 
