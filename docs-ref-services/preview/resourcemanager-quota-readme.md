...
ms.service: quota
---
# Azure Resource Manager Quota client library for Java - version 2.1.0-alpha.20260203.1 


Azure Resource Manager Quota client library for Java.

This package contains Microsoft Azure SDK for Quota Management SDK. Microsoft Azure Quota Resource Provider. Package api-version 2025-09-01. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
