...
keywords: Azure, java, SDK, API, azure-resourcemanager-deploymentmanager, deploymentmanager
ms.date: 01/30/2026
ms.topic: reference
ms.devlang: java
ms.service: deploymentmanager
---
# Azure Resource Manager Deployment client library for Java - version 1.0.0-alpha.20260130.1 
