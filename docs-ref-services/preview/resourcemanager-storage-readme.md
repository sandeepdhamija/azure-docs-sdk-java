...
keywords: Azure, java, SDK, API, azure-resourcemanager-storage, storage/azure-resourcemanager-storage
ms.date: 01/26/2026
ms.topic: reference
ms.devlang: java
ms.service: storage/azure-resourcemanager-storage
---
# Azure Resource Manager storage client library for Java - version 2.56.0-alpha.20260126.1 
