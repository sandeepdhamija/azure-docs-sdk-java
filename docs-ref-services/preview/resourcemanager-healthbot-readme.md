...
keywords: Azure, java, SDK, API, azure-resourcemanager-healthbot, azure-ai-health-bot
ms.date: 01/30/2026
ms.topic: reference
ms.devlang: java
ms.service: azure-ai-health-bot
---
# Azure Resource Manager Healthbot client library for Java - version 1.2.0-alpha.20260129.1 
