---
title: Azure Resource Manager Scvmm client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-scvmm, scvmm
ms.date: 02/03/2026
ms.topic: reference
ms.devlang: java
ms.service: scvmm
---
# Azure Resource Manager Scvmm client library for Java - version 1.1.0-alpha.20260203.1 
