...
keywords: Azure, java, SDK, API, azure-resourcemanager-subscription, subscription
ms.date: 02/04/2026
ms.topic: reference
ms.devlang: java
ms.service: subscription
---
# Azure Resource Manager Subscription client library for Java - version 1.1.0-alpha.20260204.1 
