---
title: Azure Resource Manager OperationsManagement client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-operationsmanagement, operationsmanagement
ms.date: 02/04/2026
ms.topic: reference
ms.devlang: java
ms.service: operationsmanagement
---
# Azure Resource Manager OperationsManagement client library for Java - version 1.0.0-alpha.20260204.1 
