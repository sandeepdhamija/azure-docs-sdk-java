---
title: Azure Resource Manager Advisor client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-advisor, advisor
ms.date: 01/26/2026
ms.topic: reference
ms.devlang: java
ms.service: advisor
---
# Azure Resource Manager Advisor client library for Java - version 1.1.0-alpha.20260126.1 
