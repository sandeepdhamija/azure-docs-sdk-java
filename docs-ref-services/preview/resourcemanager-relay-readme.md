...
keywords: Azure, java, SDK, API, azure-resourcemanager-relay, azure-relay
ms.date: 01/31/2026
ms.topic: reference
ms.devlang: java
ms.service: azure-relay
---
# Azure Resource Manager Relay client library for Java - version 1.1.0-alpha.20260130.1 
