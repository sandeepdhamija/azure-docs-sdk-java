---
title: Azure Resource Manager StoragePool client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-storagepool, storagepool
ms.date: 02/04/2026
ms.topic: reference
ms.devlang: java
ms.service: storagepool
---
# Azure Resource Manager StoragePool client library for Java - version 1.1.0-alpha.20260204.1 
