...
---
# Azure Event Grid client library for Java - version 4.32.0-alpha.20260204.1 
...
To learn more about Azure Event Grid: [What is Event Grid?](https://learn.microsoft.com/azure/event-grid/overview)
...
Refer to [BinaryData](https://learn.microsoft.com/java/api/com.azure.core.util.binarydata?view=azure-java-stable) documentation for details.
...
more common to use the already defined [EventGridEvent schema](https://learn.microsoft.com/azure/event-grid/event-schema) or [CloudEvent schema](https://learn.microsoft.com/azure/event-grid/cloud-event-schema). 
...
EventGrid Topic or Domain](https://learn.microsoft.com/azure/event-grid/subscribe-through-portal). 
The events sent to the topic or domain will be stored into the subscription's endpoint, also known as 
["Event Handler"](https://learn.microsoft.com/azure/event-grid/event-handlers).
...
An [Event Grid Domain](https://learn.microsoft.com/azure/event-grid/event-domains) can have thousands of topics
...
An event that is sent to a [System Topic](https://learn.microsoft.com/azure/event-grid/system-topics) is called a
System Topic Event, or System Event. 
A system topic in Event Grid represents events published by an [Event Source](https://learn.microsoft.com/azure/event-grid/overview#event-sources) like Azure Storage, Azure Event Hubs, App Configuration and so on.
...
- [Azure App Configuration](https://learn.microsoft.com/azure/event-grid/event-schema-app-configuration)
- [Azure App Service](https://learn.microsoft.com/azure/event-grid/event-schema-app-service)
- [Azure Blob Storage](https://learn.microsoft.com/azure/event-grid/event-schema-blob-storage)
- ...
- Refer to [Azure services that support system topics](https://learn.microsoft.com/azure/event-grid/system-topics#azure-services-that-support-system-topics) for many other services.
