---
title: Azure Resource Manager PowerBIDedicated client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-powerbidedicated, powerbidedicated
ms.date: 01/29/2026
ms.topic: reference
ms.devlang: java
ms.service: powerbidedicated
---
# Azure Resource Manager PowerBIDedicated client library for Java - version 1.1.0-alpha.20260129.1 
