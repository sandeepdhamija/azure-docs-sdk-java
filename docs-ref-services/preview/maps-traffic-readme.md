...
keywords: Azure, java, SDK, API, azure-maps-traffic, maps/azure-maps-traffic
ms.date: 01/30/2026
ms.topic: reference
ms.devlang: java
ms.service: maps/azure-maps-traffic
---
# Azure Maps SDK Traffic client library for Java - version 1.0.0-alpha.20260130.1 
