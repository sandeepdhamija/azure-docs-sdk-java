...
keywords: Azure, java, SDK, API, azure-resourcemanager-elastic, elastic
ms.date: 01/29/2026
ms.topic: reference
ms.devlang: java
ms.service: elastic
---
# Azure Resource Manager Elastic client library for Java - version 1.2.0-alpha.20260129.1 


Azure Resource Manager Elastic client library for Java.

This package contains Microsoft Azure SDK for Elastic Management SDK.  Package tag package-2025-06-01. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
