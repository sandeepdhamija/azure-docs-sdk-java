---
title: Azure Resource Manager support client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-support, support
ms.date: 01/30/2026
ms.topic: reference
ms.devlang: java
ms.service: support
---
# Azure Resource Manager support client library for Java - version 1.2.0-alpha.20260130.1 
