---
title: Azure Resource Manager Education client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-education, education
ms.date: 02/04/2026
ms.topic: reference
ms.devlang: java
ms.service: education
---
# Azure Resource Manager Education client library for Java - version 1.0.0-alpha.20260203.1 
