...
keywords: Azure, java, SDK, API, azure-resourcemanager-avs, avs
ms.date: 02/07/2026
ms.topic: reference
ms.devlang: java
ms.service: avs
---
# Azure Resource Manager Avs client library for Java - version 1.5.0-alpha.20260206.1 


Azure Resource Manager Avs client library for Java.

This package contains Microsoft Azure SDK for Avs Management SDK. Azure VMware Solution API. Package api-version 2025-09-01. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
