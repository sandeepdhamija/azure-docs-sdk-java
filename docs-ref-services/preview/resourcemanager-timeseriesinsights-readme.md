...
keywords: Azure, java, SDK, API, azure-resourcemanager-timeseriesinsights, timeseriesinsights
ms.date: 01/29/2026
ms.topic: reference
ms.devlang: java
ms.service: timeseriesinsights
---
# Azure Resource Manager TimeSeriesInsights client library for Java - version 1.1.0-alpha.20260129.1 
