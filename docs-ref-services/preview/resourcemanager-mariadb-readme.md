---
title: Azure Resource Manager MariaDB client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-mariadb, mariadb
ms.date: 01/27/2026
ms.topic: reference
ms.devlang: java
ms.service: mariadb
---
# Azure Resource Manager MariaDB client library for Java - version 1.1.0-alpha.20260127.1 
