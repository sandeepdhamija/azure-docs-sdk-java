---
title: Azure Resource Manager orbital client library for Java
keywords: Azure, java, SDK, API, azure-resourcemanager-orbital, orbital
ms.date: 02/06/2026
ms.topic: reference
ms.devlang: java
ms.service: orbital
---
# Azure Resource Manager orbital client library for Java - version 1.1.0-alpha.20260205.1 
